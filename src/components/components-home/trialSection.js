...
import './trialSection.css';
import homedata from '../../data/homedata.json';
import Quran1 from './quran1.jpg'; // Static image import for optimal performance

const TrialSection = () => {
  // Render only once to avoid memory consumption issues in production mode
  return (
    <>
      <img className="BismillAllahLogo" src="/assets/img/BismillAllah.jpg" alt="Bismillah Logo" />

      <section
        className="p-80px-tb parallax bg-color opacity-5"

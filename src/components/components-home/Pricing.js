...
const Pricing = () => {
    // Memoize pricing data to avoid unnecessary re-renders
    const pricingData = useMemo(() => homedata.pricingtable.tables, []);

    return (
        <section 
            id="pricing" 
            className="p-80px-tb parallax bg-colors opacity-5" 
                                    ...
                                    <div className="pricing-head-text">
                                        <div className="package-price">
                                            <span className="price">
                                                {data.currency}{data.Startprice}-{data.Endprice}{' '}
                                                <span style={{ fontSize: "0.5em" }}>{data.usd}</span>
                                            </span><br />
                                            <span className="validity">{data.duration}</span>
                                        </div>
                                    </div>
                                    <span className="wave"></span>
                                    <span className="wave"></span>
